...
""" Fast Start Example #8 - Agents
    ...
    This example shows how to build locally-running Agents deploying multiple small specialized function-calling
    models as tools with an integrated work management, process and journaling capability using the LLMfx class.

    This example shows a workflow receiving a customer transcript, and having an agent run through a series of
    analytical and classification steps.
